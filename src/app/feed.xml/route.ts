...
<rss version="2.0" xmlns:content="http://purl.org/rss/1.0/modules/content/" xmlns:wfw="http://wellformedweb.org/CommentAPI/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:atom="http://www.w3.org/2005/Atom" xmlns:sy="http://purl.org/rss/1.0/modules/syndication/" xmlns:slash="http://purl.org/rss/1.0/modules/slash/">
  <channel>
    <title>Ismat Samadov - Backend Developer Blog</title>
    <atom:link href="${baseUrl}/feed.xml" rel="self" type="application/rss+xml"/>
    <link>${baseUrl}</link>
    <description>Backend Development insights, SQL optimization techniques, and AI development tutorials by Ismat Samadov</description>
    ...
    <image>
      ...
      <width>1200</width>
      <height>630</height>
      <description>Backend Development insights and tutorials</description>
    </image>
    ${blogPosts.map(post => `
    <item>
